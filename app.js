...
const slider_load = () => {
    setTimeout(() => {
        header.style.background = "url('img/121218.jpg') no-repeat center center/cover"
        header_dur.innerText = "2 Sezon";
        header_gen.innerHTML = '<i class="fas fa-star"></i>9.3 <span>Belgesel</span>';
        header_title.innerText = "Gezegenimiz";
        header_pra.innerText = "Muazzam bir içeriğe sahip olan bu çarpıcı belgeselde, gezegenimizin doğal güzelliğine şahit olurken iklim değişikliğinin tüm canlıları nasıl etkilediğini göreceksiniz.";
    ...
    setTimeout(() => {
        header.style.background = "url('img/121217.jpg') no-repeat center center/cover"
        header_dur.innerText = "6 Sezon";
        header_gen.innerHTML = '<i class="fas fa-star"></i>9.1 <span>Animasyon / Bilim Kurgu / Komedi</span>';
        header_title.innerText = "Rick and Morty";
        header_pra.innerText = "Parlak zekalı fakat alkolik bilim adamı Rick, başka dünyalara ve alternatif boyutlara çılgın kaçamaklar yaparken huysuz torunu Morty'i de zorla yanında götürür.";
    ...
    setTimeout(() => {
        ...
        header_dur.innerText = "3 Sezon";
        header_gen.innerHTML = '<i class="fas fa-star"></i>8.7 <span>Suç / Drama / Gizem</span>';
        header_title.innerText = "Dark";
        header_pra.innerText = "Bir çocuğun kaybolması, dört aileyi hummalı bir cevap arayışına iter. Bu arayışları, üç nesli kapsayan akıl almaz bir gizemi ortaya çıkarmalarına neden olur.";
        slider_btn[0].style.background = "rgb(184, 184, 184, .1)";
        slider_btn[1].style.background = "rgb(184, 184, 184, .1)";
...
video_1[0].addEventListener('click', () => {
    videos.src = "video/Our Planet .mp4";
    videos.play();
    title_video[0].innerText = "Gezegenimiz";
    plays.classList.add('bi-pause-fill');
    plays.classList.remove('bi-play-fill');
});
video_1[1].addEventListener('click', () => {
    videos.src = "video/rickandmorty.mp4";
    videos.play();
    title_video[0].innerText = "Rick and Morty";
    plays.classList.add('bi-pause-fill');
    plays.classList.remove('bi-play-fill');
});
video_1[2].addEventListener('click', () => {
    videos.src = "video/dark.mp4";
    videos.play();
    title_video[0].innerText = "Dark";
    plays.classList.add('bi-pause-fill');
    plays.classList.remove('bi-play-fill');
});
...
const movies = [{
    id: 36,
    img: "mimg/mirror_black.jpg",
    down_img: "img/black_mirror.jpg",
    title: "Black Mirror",
    letter: "b",
    genre1: "action",
    genre2: "none",
    ...
    year: 2011,
    rate: 8.7,
    url: "black_mirror.html",
    tppr: "trend",
    msot: "movie",
    screen1: "img/mirror1.jpg",
    screen2: "img/mirror2.jpg",
    screen3: "img/mirror3.jpg",
    ph420: "img/mirror4.jpg",
    ph720: "img/mirror5.jpg",
    ph1080: "img/mirror6.jpg",
},
{
    id: 35,
    img: "mimg/comndo.jpg",
